...
class User(Base):
    ...
    pomodoro_study_minutes = Column(Integer, nullable=True)
    pomodoro_short_break_minutes = Column(Integer, nullable=True)
    pomodoro_long_break_minutes = Column(Integer, nullable=True)
